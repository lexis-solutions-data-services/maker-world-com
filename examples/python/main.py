...
def run_actor():
    """Run the maker-world-com actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/maker-world-com"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://makerworld.com/en/3d-models/901-3d-printer-accessories"},{"url":"https://makerworld.com/en/search/models?keyword=halloween"},{"url":"https://makerworld.com/en/models/652863-the-forbidden-fruit#profileId-579671"}],
            "maxItems": 10,
